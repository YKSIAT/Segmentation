...
class ParallelProcessingN4BiasedField:
    def __init__(self, data_path, save_path, max_workers=20):
...
if __name__ == "__main__":
    ...
    save_path_ = "/home/yk/Project/keras/dataset/N4BiasedField"
    # data_root_path = r"H:\dataset\BraTs"
    data_root_path = "/home/yk/Project/keras/dataset/BraTs"
